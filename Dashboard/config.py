...
OUTCOME_COLORS: Dict[str, str] = {
    ...
    'missed': '#999999',         # Gray (block attempted but didn't touch ball)
...
VALID_OUTCOMES: List[str] = [
    ...
    'missed',      # Block attempted but didn't touch ball
...
VALID_ATTACK_TYPES: List[str] = ['normal', 'tip', 'after_block']
...
ACTION_OUTCOME_MAP: Dict[str, List[str]] = {
    ...
    'free_ball': ['good', 'error']  # Generic for free balls
}
