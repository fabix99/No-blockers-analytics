...
def test_import_modules():
    ...
    from utils import validate_uploaded_file, save_uploaded_file_securely
    from utils.formatters import format_percentage, get_performance_color
    from ui.components import display_match_banner, get_position_full_name
    from config import KPI_TARGETS, CHART_COLORS
